...
class AboutIteration(Koan):
    ...
    def test_reduce_will_blow_your_mind(self):
        ...
        #
        # Reduce:
        # Repeatedly executes a function on two elements of an iterable, each time 'reducing' the
        # number of elements in said iterable. When the number of elements reaches 1, it returns it.
